...
<!-- We will first revisit in detail the fundamental building blocks of mathematical statistics, beginning with probability theory, random variables, and probability distributions. -->
<!-- We will also learn about convergences of random variables in order to understand several important results in statistics (e.g. the law of large numbers and the central limit theorem). -->
<!-- The syllabus then focuses on the three important statistical inference activities: point estimation, interval estimation, and hypothesis testing. -->
...
<!-- 4. To be self-independent in your studies. I understand that attending weekly, physical classes gives you a form of structure, and gives you comfort. Having video lectures and self-reading tasks is the opposite of this. This is an opportunity to instill self-discipline in yourself if you don't have any to begin with, or to strengthen it if you've had some! If you stick to the schedule, complete all the tasks, you will do well, إن شاء الله. -->

<!-- ## Module information {-} -->

<!-- ### Class format {-} -->

<!-- Blended learning (mixture of face-to-face and online teaching). Following recommended university guidelines, I will conduct at least 40% of the course through online learning. Therefore, the format is as follows: -->

<!-- - **Self-study**. Every week you will be given a recommended reading list. You should also complete reading of the chapter of the class notes for that particular week. -->

<!-- - **Mini videos and online lectures**. I plan to create mini videos *or* hold lectures during lecture hours, with the aim of spending time explaining the concepts which I feel students have most difficulty grasping. These should always be supplemented with the mandatory reading, and preferably you should complete the reading before attending/viewing these. -->
<!-- <!-- Each topic will be presented via videos released incrementally topic by topic. You may view these at your leisure, but you should aim to complete the viewings before the next set of videos are released. You are encouraged to take notes. There will not be any face-to-face or Zoom lectures. -->

<!-- - **Tutorials**. We will have a 2-hour tutorial class (face-to-face if permitted, online if not) every other week. These tutorials will be assessed. -->

<!--    - If we have a live session, you will volunteer or be called upon to present the answers to the exercises. This means coming up to the whiteboard and writing and explain your solutions. -->

<!--    - If we have an online session, then I will assign questions to everyone so you can prepare before coming to tutorial class (just to make the process smoother). You can then scan and present your solutions online. -->

<!-- - **Breather/Recap sessions**. We will dedicate a 2-hour face-to-face class (if permitted, otherwise online) every other week to recap the completed chapter. During these sessions, you will have the opportunity to clarify any concept or idea that you are still unsure of. No new materials will be taught, it is only for answering questions. You may not ask about the "starred" questions in the tutorials directly. -->

<!-- Two weekly sessions are timetabled: *Tuesdays 1410-1600* and *Wednesdays 1150-1340*.  -->
<!-- <!-- Tuesday sessions will be for tutorials and Wednesdays for breather/recap sessions. --> 
...
<!-- Formative assessments do not count towards your grade, but summative ones do. -->

<!-- #### Formative assessment {-} -->

<!-- - 1 $\times$ mock exam in Week 13 -->
<!-- - Exercise sheets -->

<!-- #### Summative assessment {-} -->

<!-- - **60% examination**: actual format TBC -->

<!--    - *Option 1 (preferred):* Closed-book, real-life and invigilated with "typical" worked out solutions type questions.  -->

<!--    - *Option 2*: Closed-book, online invigilated examination.  -->

<!--    The scheduled date for the exam is *DATE* at Chancellor Hall (more details closer to the date). Answer 3 out of 4 questions. Calculators are allowed. A minimal formulae sheet will be provided, as well as statistical tables. -->

<!-- - **20% topical tests**: Open-book, multiple choice format, online submission through Canvas. There will be six tests in total, corresponding to each topic/part of the module. In total, there are 100 equally weighted questions (0.2 points each) so each test will have 10-15 questions depending on the chapter. Each test will be available as soon as a new topic is taught, and will be available until the next topic is taught. You may take the test at any time in between. You will have 4 hours to complete the test once you start it. -->

<!-- - **10% tutorials**: There are 6 planned tutorial sessions, corresponding to 6 exercise sheets. The majority of the questions are for practice (formative assessment), but there will 1-3 "hand-in" questions which you will have to submit for grading. The total marks for all of these star questions will be 100, which then counts for 10% of the overall summative mark. -->

<!-- - **10% participation**: I will award marks based on your participation during tutorial sessions, breather/recap sessions, as well as online Canvas discussion groups. The marks will reflect your participation level for the entire semester. The rubric is found in the table below. -->
